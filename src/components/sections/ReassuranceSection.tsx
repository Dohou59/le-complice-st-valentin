    ...
    return (
        <section className="py-16 bg-white border-t border-gray-100">
            <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                    { l: "EXPÉDIÉ SOUS 48H", i: "/icons/Camion.jpeg" },
                    { l: "PAIEMENT SÉCURISÉ", i: "/icons/Cadenas.jpeg" },
                    { l: "SATISFAIT OU REMBOURSÉ", i: "/icons/coche.jpeg" },
                    { l: "PRÊT À OFFRIR", i: "/icons/Cadeau.jpeg" }
                ].map((r, i) => (
